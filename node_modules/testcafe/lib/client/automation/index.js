						...
						"utils.js": function (exports, module, require) {
							...
							function focusAndSetSelection(element, simulateFocus, caretPos) {
							    return new Promise(function (resolve) {
							        ...
							        var shouldFocusByRelatedElement = labelWithForAttr;
							        var isContentEditable = domUtils.isContentEditableElement(element);
			...
			"errors": {
				"test-run": {
					"index.js": function (exports, module, require) {
						...
						var RequestHookUnhandledError = exports.RequestHookUnhandledError = function (_TestRunErrorBase45) {
						    _inherits(RequestHookUnhandledError, _TestRunErrorBase45);

						    function RequestHookUnhandledError(err, hookClassName, methodName) {
						        _classCallCheck(this, RequestHookUnhandledError);

						        var _this63 = _possibleConstructorReturn(this, _TestRunErrorBase45.call(this, _types.TEST_RUN_ERRORS.requestHookUnhandledError));

						        _this63.errMsg = String(err);
						        _this63.hookClassName = hookClassName;
						        _this63.methodName = methodName;
						        return _this63;
						    }
						...
						var RequestHookNotImplementedMethodError = exports.RequestHookNotImplementedMethodError = function (_TestRunErrorBase46) {
						    _inherits(RequestHookNotImplementedMethodError, _TestRunErrorBase46);
						    ...
						    function RequestHookNotImplementedMethodError(methodName, hookClassName) {
						        ...
						        var _this64 = _possibleConstructorReturn(this, _TestRunErrorBase46.call(this, _types.TEST_RUN_ERRORS.requestHookNotImplementedError));

						        _this64.methodName = methodName;
						        _this64.hookClassName = hookClassName;
						        return _this64;
						    }
