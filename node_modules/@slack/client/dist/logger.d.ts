 ...
 */
export declare function loggerFromLoggingFunc(name: string, loggingFunc: LoggingFunc, level: LogLevel): Logger;
/**
 * INTERNAL determine if a value is a LoggingFunc
 */
export declare function isLoggingFunc(l: Logger | LoggingFunc): l is LoggingFunc;
