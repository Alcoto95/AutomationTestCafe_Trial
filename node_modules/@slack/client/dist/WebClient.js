...
class WebClient extends EventEmitter {
    ...
    constructor(token, { slackApiUrl = 'https://slack.com/api/', logger = undefined, logLevel = logger_1.LogLevel.INFO, maxRequestConcurrency = 3, retryConfig = retry_policies_1.default.retryForeverExponentialCappedRandom, agent = undefined, tls = undefined, pageSize = 200, rejectRateLimitedCalls = false, clientId = undefined, clientSecret = undefined, refreshToken = undefined, headers = {}, } = {}) {
        ...
        // Logging
        if (logger !== undefined && logger_1.isLoggingFunc(logger)) {
            this.logger = logger_1.loggerFromLoggingFunc(WebClient.loggerName, logger, logLevel);
        ...
        this.axios = axios_1.default.create({
            ...
            httpAgent: util_1.agentForScheme('http', agent),
            httpsAgent: util_1.agentForScheme('https', agent),
        ...
        if (this.shouldAutomaticallyRefreshToken) {
            this.logger.warn('Automatic token refresh has been deprecated and will be removed from the next major version of the ' +
    ...
    apiCall(method, options, callback) {
        ...
        const implementation = () => __awaiter(this, void 0, void 0, function* () {
            ...
            if (shouldAutoPaginate) {
                this.logger.warn('Auto pagination is deprecated. Use the `cursor` and `limit` arguments to make paginated calls.');
            }
            /**
        ...
        if (callback !== undefined) {
            this.logger.warn('Using callbacks has been deprecated, and will not work in the next major version of WebClient. Instead, ' +
